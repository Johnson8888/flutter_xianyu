/*
 * @Author: 弗拉德
 * @Date: 2021-02-09 22:10:54
 * @LastEditTime: 2021-02-09 22:14:25
...
/// 球脉冲Footer
class LoadingFooter extends Footer {
  /// Key
  final Key key;
...
/// 球脉冲组件
class LoadingFooterWidget extends StatefulWidget {
  /// 颜色
  final Color color;
  ...
  @override
  LoadingFooterWidgetState createState() {
    return LoadingFooterWidgetState();
  }
}

class LoadingFooterWidgetState extends State<LoadingFooterWidget> {
